...
private:
  ...
  bool mFilterMenu;  //!< searching should perform hiding nonmatching items in
                     //!< menu
  ...
  bool mFilterShowHideMenu; //!< while searching all (original) menu entries
                            //!< should be hidden
  bool mHeavyMenuChanges; //!< flag for filtering some mMenu events while heavy
...
class LXQtMainMenuPluginLibrary : public QObject,
