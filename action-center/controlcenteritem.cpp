...
void controlcenteritem::setupUi(QWidget *Form) {
    ...
    sizePolicy1.setHeightForWidth(
                quicksettinglabel->sizePolicy().hasHeightForWidth());
    ...
    nightmode->setStyleSheet(
                QString::fromUtf8("QToolButton {background: #ebeef5}"));
    QIcon icon1;
    ...
    sizePolicy3.setHeightForWidth(
                BrightnessSlider->sizePolicy().hasHeightForWidth());
    BrightnessSlider->setSizePolicy(sizePolicy3);
    BrightnessSlider->setRange (20,90);
    BrightnessSlider->setMaximumSize(QSize(420, 16777215));
    BrightnessSlider->setOrientation(Qt::Horizontal);

    brightnessLayout->addWidget(BrightnessSlider);
    brightPercentShow = new QLabel(layoutWidget);
    ...
    sizePolicy3.setHeightForWidth(
                bluelightslider->sizePolicy().hasHeightForWidth());
    ...
    bluePercentShow = new QLabel(layoutWidget);
    ...
    audioPercentShow = new QLabel(layoutWidget);
    ...
    sizePolicy4.setHeightForWidth(
                notificationlabel->sizePolicy().hasHeightForWidth());
    ...
    sizePolicy5.setHeightForWidth(
                clearNotifyBtn->sizePolicy().hasHeightForWidth());
    ...
    notifyScrollContents->setObjectName(
                QString::fromUtf8("notifyScrollContents"));
...
void controlcenteritem::retranslateUi(QWidget *Form) {
    ...
    quicksettinglabel->setText(
                QCoreApplication::translate("Form", "Quick Setting", nullptr));
    wifi->setText(QCoreApplication::translate("Form", "Wifi", nullptr));
    nightmode->setText(
                QCoreApplication::translate("Form", "Night Mode", nullptr));
    ...
    allsetting->setText(
                QCoreApplication::translate("Form", "All Setting", nullptr));
    locale->setText(QCoreApplication::translate("Form", "Locale", nullptr));
    airplanemode->setText(
                QCoreApplication::translate("Form", "Airplane Mode", nullptr));
    ...
    notificationlabel->setText(
                QCoreApplication::translate("Form", "Notification", nullptr));
    clearNotifyBtn->setText(
                QCoreApplication::translate("Form", "Clear all", nullptr));
