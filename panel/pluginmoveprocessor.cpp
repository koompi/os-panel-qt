 ...
 ************************************************/
PluginMoveProcessor::PluginMoveProcessor(LXQtPanelLayout *layout,
                                         Plugin *plugin)
...
void PluginMoveProcessor::mouseMoveEvent(QMouseEvent *event) {
  ...
  // But if next item and moved plugin have different types (separate an not)
  // and previous item hase same type as moved plugin we draw line at the end of
  // previous one.
 ...
 ************************************************/
PluginMoveProcessor::MousePosInfo
PluginMoveProcessor::itemByMousePos(const QPoint mouse) const {
  MousePosInfo ret;
